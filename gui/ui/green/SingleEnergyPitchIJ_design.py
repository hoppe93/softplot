...
class Ui_SingleEnergyPitchIJ(object):
    def setupUi(self, SingleEnergyPitchIJ):
        ...
        self.cbUnderlay = QtWidgets.QCheckBox(self.centralwidget)
        self.cbUnderlay.setGeometry(QtCore.QRect(460, 580, 81, 25))
        self.cbUnderlay.setObjectName("cbUnderlay")
    ...
    def retranslateUi(self, SingleEnergyPitchIJ):
        ...
        self.cbUnderlay.setText(_translate("SingleEnergyPitchIJ", "Reversed"))
